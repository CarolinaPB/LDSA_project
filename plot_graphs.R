...
plot(vertical$Threads_num, vertical$Part_1, xlab="# Threads",ylim=c(250,2100), ylab="Time (s)", type="b", col=460, main = "Vertical Scaling", xaxt='n')
axis(1, at = c(1,2,3),font = 2)
axis(2, font = 2)
